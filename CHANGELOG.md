...
## [0.2.5](https://github.com/TheHiddenLayer/z/compare/v0.2.4...v0.2.5) - 2026-05-27

### Other

- *(wizard)* use solid dividers

## [0.2.4](https://github.com/TheHiddenLayer/z/compare/v0.2.3...v0.2.4) - 2026-05-21

### Other

- *(tui)* deslop layout helpers

## [0.2.3](https://github.com/TheHiddenLayer/z/compare/v0.2.2...v0.2.3) - 2026-05-20

### Other

- Merge pull request #58 from TheHiddenLayer/simple-styles
- *(ui)* simplify status chrome

## [0.2.2](https://github.com/TheHiddenLayer/z/compare/v0.2.1...v0.2.2) - 2026-05-20

### Other

- authenticate release head check
- skip stale release PR runs

## [0.2.1](https://github.com/TheHiddenLayer/z/compare/v0.2.0...v0.2.1) - 2026-05-20

### Other

- wait for release PR checks to appear
